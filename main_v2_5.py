...
def export_to_excel(dataframes, output_file, summary_rows):
    """
    Exporta:
    1. Una hoja "Resumen" con la info de summary_rows (estadísticas por año).
    2. Hojas por cada año con subtotales y una fila celeste para 'Sub-total'.
    """
    from openpyxl.styles import PatternFill
...
def main():
    """
    Programa principal: solicita el rango de años, ejecuta las consultas y exporta resultados:
     - Hoja "Resumen" con las estadísticas solicitadas
     - Hojas por año con subtotales y filas celestes de 'Sub-total'.
    """
    ...
    try:
        ...
        # Exportar a Excel
        if dataframes:
            export_to_excel(dataframes, output_file, summary_stats)
        else:
